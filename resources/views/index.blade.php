                    ...
                    <div class="ml-auto w-25">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul
                                ...
                                <li class="cta"><a href="/login"><span>Sign In</span></a></li>
                            </ul>
                        </nav>
                        <a href="#"
            ...
            <div class="row">
                <div class="owl-carousel col-12 nonloop-block-14">
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ1.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <h3><a href="#">Politeknik Energi dan Pertambangan Bandung</a></h3>
                            <p>D3 Teknologi Pertambangan.</p>
                        </div>
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ2.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                            <h3><a href="#">Universitas Padjajaran</a></h3>
                            <p>S1 Agroteknologi.</p>
                        </div>
                        <div class="d-flex border-top stats">
                            <div class="py-3 px-4"><span class="icon-users"></span> Kuota</div>
                            <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ3.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                            <h3><a href="#">Politeknik Jember</a></h3>
                            <p>S1 Agronomi</p>
                        </div>
                        <div class="d-flex border-top stats">
                            <div class="py-3 px-4"><span class="icon-users"></span> Kuota</div>
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ4.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                            <h3><a href="#">Universitas Kaltara</a></h3>
                            <p>S1 Agroteknologi</p>
                        </div>
                        <div class="d-flex border-top stats">
                            <div class="py-3 px-4"><span class="icon-users"></span> Kuota</div>
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ5.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                            <h3><a href="#">Xiamen University</a></h3>
                            <p>Bachelor of Engineering in Digital Media Technology</p>
                        </div>
                        <div class="d-flex border-top stats">
                            <div class="py-3 px-4"><span class="icon-users"></span> Kuota</div>
                            <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ6.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                            <h3><a href="#">Universitas Borneo Tarakan</a></h3>
                            <p>S1 Pendidikan</p>
                        </div>
                        <div class="d-flex border-top stats">
                            <div class="py-3 px-4"><span class="icon-users"></span> Kuota</div>
                    ...
                    <div class="course bg-white h-100 align-self-stretch">
                        <figure class="m-0">
                            <a href="course-single.html"><img src="assets/images/univ7.jpg" alt="Image"
                                    class="img-fluid"></a>
                        </figure>
                        <div class="course-inner-text py-4 px-4">
                            <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                            <h3><a href="#">Politeknik Elektronika Negeri Surabaya</a></h3>
                            <p>LD3 Teknik Informatika</p>
                        </div>
                        <div class="d-flex border-top stats">
                            <div class="py-3 px-4"><span class="icon-users"></span> Kuota</div>
                            <div class="py-3 px-4 w-25 ml-auto border-left"><span class="icon-chat"></span> 2</div>
                ...
                <div class="col-md-8 text-center testimony">
                    ...
                    <blockquote>
                        <p>&ldquo; Meningkatkan kualitas hidup masyarakat sehingga dapat memberikan kemakmuran yang
                            berkelanjutan dan oleh karena itu mendapatkan rasa hormat dan dihargai oleh seluruh pihak
                            terkait. &rdquo;</p>
                    </blockquote>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7">
                    ...
                    <p class="mb-5">Jika Anda memiliki pertanyaan atau ingin mendapatkan informasi lebih lanjut
                        mengenai program beasiswa atau lainnya, jangan ragu untuk menghubungi kami. Kami siap membantu!
                    </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>PT Pesona Khatulistiwa Nusantara (PT PKN) adalah perusahaan yang bergerak di bidang pertambangan
                        batubara pemegang izin Perjanjian Karya Pengusahaan Pertambangan Batubara (PKP2B) Generasi III.
                ...
                <div class="col-md-3 ml-auto">
                    ...
                    <ul class="list-unstyled footer-links">
                        ...
                        <li><a href="https://id.linkedin.com/company/pt.-pesona-khatulistiwa-nusantara">LinkEdIN</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-4">
                    <h3>Wilayah</h3>
                    <p>Wilayah operasional seluas 21.875 Ha terbagi menjadi 2 blok yaitu blok utara dan blok selatan.
                        Pada blok utara terbagi menjadi 2 area yaitu area Kelubir dan Ardimulyo sedangkan blok selatan
